...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
            ...
            <!--<form class="ml-lg-auto form-inline">
              ...
              <button type="submit" class="add-on"><i class="fa fa-search"></i></button>
                ...
                <ul class="navbar-nav ml-lg-auto mr-3">
                    ...
                    <li class="nav-item">
                        <a href="film-marketing.php" class="nav-link smoothScroll ">MARKETING</a>
                    </li>
                    <li class="nav-item">
                        <p class="nav-link line-hide">|</p>
                    </li>
    ...
    <div class="d-flex flex-column hero-text">POSTER DESIGN</div>
            <!-- Set up your HTML -->
            <div id="up" class="owl-carousel owl-carousel-hero owl-theme d-none d-md-block">

              <div class="item"><img class="hero-img" src="images/poster-design/1.png"> </div>
              <div class="item"><img class="hero-img" src="images/poster-design/2.png"> </div>
              <div class="item"><img class="hero-img" src="images/poster-design/3.png"> </div>
              <div class="item"><img class="hero-img" src="images/poster-design/4.png"> </div>
              <div class="item"><img class="hero-img" src="images/poster-design/5.png"> </div>
            </div>
        ...
        <div class="container carousel-container">
            ...
            <div id="owl-carousel-marketing" style="text-align: -webkit-center;" class="owl-carousel owl-theme">
                ...
                for ($p=0; $p <$pages ; $p++) { 
                  ...
                  echo '<div class="grid-container-1" id="film-marketing-'.$p.'">';
                  for ($i=0; $i < $rows ; $i++) {
                    for ($j=0; $j <$cols ; $j++,$k++) { 
                      if (!empty($latestImages[$k])) {
                        echo  '<div class="grid-item" data-mname="">';
                        echo '<img class="grid-img lazyOwl" src="images/poster-design/posters/'.$latestImages[$k].'">';
                        echo '</div>';
                      }
                    }
                  }
                ...
                /*for ($i=0; $i <= $pages ; $i++) { 
                  echo '<div class="item grid-margin" >';
                  echo '<div class="grid-container-1" id="film-marketing-'.$i.'">';
                  for ($j=0; $j <=$totalImages ; $j++) { 
                    echo  '<div class="grid-item" data-mname="bajirao mastani">';
                    echo '<h2 class="text-white>'.$images[$j].'</h2>';
                    // echo '<img class="grid-img lazyOwl" src="images/poster-design/posters/'.$images[$j].'">';
                    echo '</div>';
                  }
                  echo '</div>';
                  echo '</div>';
